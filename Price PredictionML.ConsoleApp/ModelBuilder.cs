...
{
    private static string TRAIN_DATA_FILEPATH = @"G:\C# Corner Stuff\Price Prediction\price-data.csv";
    private static string MODEL_FILEPATH = @"../../../../Price PredictionML.Model/MLModel.zip";
